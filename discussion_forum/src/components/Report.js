  ...
  return (
    ...
    >
      <Container className="mt-4">
        <Row>
          <Col className="">
            <h3 className="Feedback_col mt-3  text-center display-6 text-uppercase ">
              Report
            </h3>
            <p className="text-center text-set mt-2">
              Help us to Make a Friendly Platform.
            </p>
          </Col>
        </Row>
